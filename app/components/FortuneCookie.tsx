...
export default function FortuneCookie() {
  ...
  return (
    <motion.section
      id="fortune-cookie"
      className="py-24 bg-sky-50/30 relative z-20 border-t border-slate-200/50"
    ...
    >
      <div className="max-w-md mx-auto px-6 text-center">
        <h2 className="text-xs font-extrabold uppercase tracking-[0.3em] text-sky-600 mb-2">
          Mini-Game Two
        </h2>
        <h3 className="text-3xl font-serif font-black text-slate-900 mb-8">
          The Oracle Cookie
        </h3>
        ...
        <div className="bg-white border border-slate-200 p-8 rounded-3xl shadow-[0_4px_20px_rgba(15,23,42,0.02)] min-h-[260px] flex flex-col justify-between items-center">
          ...
          <motion.div
            ...
            whileTap={{ scale: 0.9, rotate: isCracked ? 0 : 15 }}
            ...
            <AnimatePresence mode="wait">
              {isCracked ? (
                ...
                <motion.p
                  ...
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  className="text-slate-400 text-xs font-semibold tracking-wide uppercase animate-pulse"
                >
          ...
          <motion.button
            onClick={handleCrack}
            whileHover={{ scale: 1.05, borderColor: "#0ea5e9", color: "#0284c7" }}
            whileTap={{ scale: 0.95 }}
            className="mt-4 text-[10px] font-bold uppercase tracking-widest text-slate-500 border border-slate-200 px-4 py-2 rounded-xl transition-colors bg-white shadow-sm"
          >
